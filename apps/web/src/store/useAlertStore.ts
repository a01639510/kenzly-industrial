...
const INITIAL_ALERTS: Alert[] = [
  {
    id: 'a1', severity: 'critical', machineId: 'injector-1', machineName: 'Inyectora Haitian MA900/II',
  ...
  {
    id: 'a2', severity: 'high', machineId: 'CHILLER-UNIT-01', machineName: 'Chiller Frigel Microgel 7.5T',
  ...
  {
    id: 'a3', severity: 'medium', machineId: 'OVEN-B2', machineName: 'Secador Drymax HopperLoader 200',
  ...
  {
    id: 'a4', severity: 'low', machineId: 'HOPPER-LOAD-01', machineName: 'Tolva Gravimétrica 500L',
  ...
  {
    id: 'a5', severity: 'high', machineId: 'injector-1', machineName: 'Inyectora Haitian MA900/II',
  ...
  {
    id: 'a6', severity: 'medium', machineId: 'METROLOGY_01', machineName: 'CMM Mitutoyo CRYSTA-Apex',
